const s="humanos_",r=[{id:"post-1",title:"You Are Not A Standard Deviation",excerpt:"Why the 15-page paper intake and 5-minute clinical documentation are breaking healthcare, and how securing your continuous lived experience is the only way to fight back.",category:"Patient Rights",read_time_minutes:5,published:!0,created_date:"2026-03-06T10:00:00Z",content:`# The 5-Minute Tragedy
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-2",title:"Escaping the Medication Gallery",excerpt:"Drugging symptoms out of administrative convenience is ruining lives. It is time to demand root-cause documentation.",category:"Movement Stories",read_time_minutes:8,published:!0,created_date:"2026-03-07T14:30:00Z",content:`# The Convenience of the Prescription Pad
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-3",title:"Sovereignty is Accountability",excerpt:"Why owning your health data isn't just about privacy from hackers—it's about wielding power against a broken system.",category:"Technology",read_time_minutes:6,published:!0,created_date:"2026-03-08T09:15:00Z",content:`# Power, Not Just Privacy
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-4",title:"The Bill For Your Silenced 5 Minutes",excerpt:"You gave them 15 pages and 20 minutes of your life. They gave you 5 minutes and a prescription. Here is the actual financial and emotional cost of being unheard.",category:"Movement Stories",read_time_minutes:7,published:!0,created_date:"2026-03-09T10:00:00Z",content:`# The Cost of Being Ignored
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-5",title:"The American Hustle vs. The Human Doctor",excerpt:"I thought I was the problem. Then I realized the system isn't just failing patients—it’s actively robbing doctors of the ability to practice medicine.",category:"Movement Stories",read_time_minutes:6,published:!0,created_date:"2026-03-10T14:00:00Z",content:`# "I Thought I Was the Problem"
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-6",title:"The Death of Privacy, The Birth of Sovereignty",excerpt:'Why "Privacy" is a weak corporate promise for people with something to hide, while "Sovereignty" is a structural guarantee for people with something to protect.',category:"Patient Rights",read_time_minutes:8,published:!0,created_date:"2026-03-11T10:00:00Z",content:`# The Lie of Data Privacy
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-7",title:"The Human Operating System Manifesto",excerpt:"A comprehensive declaration of our intent to dismantle the assembly-line medical machine and replace it with a patient-first data ecosystem.",category:"Policy & Regulation",read_time_minutes:12,published:!0,created_date:"2026-03-12T12:00:00Z",content:`# The Declaration of Health Independence
...
We are not just building software; we are architecting a rebellion against the medical status quo. The current system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-8",title:"The 15-Page Paper Wall",excerpt:"How clinical intake paperwork is designed to induce fatigue, erase patient nuance, and protect the hospital from liability rather than actually documenting you.",category:"Movement Stories",read_time_minutes:7,published:!0,created_date:"2026-03-13T09:00:00Z",content:`# The Weaponization of Paperwork
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-9",title:"Zero-Knowledge: Why We Don't Want Your Password",excerpt:"A deep dive into the cryptography that makes hOS mathematically incapable of selling or leaking your data.",category:"Technology",read_time_minutes:9,published:!0,created_date:"2026-03-14T14:30:00Z",content:`# The Architecture of Trustlessness
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-10",title:"Founded in a Motel Room",excerpt:"The raw, unfiltered origin story of the Humanos Foundation, built against the odds by a patient navigating chronic illness.",category:"Community",read_time_minutes:6,published:!0,created_date:"2026-03-15T11:00:00Z",content:`# The Birthplace of hOS
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-11",title:"How to Reclaim Your Medical Record Today",excerpt:"Don't wait for the system to change. Here are three actionable steps you can take today to legally reclaim your scattered health history.",category:"Patient Rights",read_time_minutes:5,published:!0,created_date:"2026-03-16T16:00:00Z",content:`# Your Data is Scattered
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`},{id:"post-12",title:"The Algorithm of Empathy: Why AI Must Serve the Patient",excerpt:"Artificial Intelligence in healthcare is inevitable. The question is: Will it be used by hospitals to bill you faster, or by you to advocate for your health?",category:"Technology",read_time_minutes:8,published:!0,created_date:"2026-03-17T09:00:00Z",content:`# The Crossroads of Clinical AI
...
The system only listens when the truth is unignorable. [Join the Movement](/Join) today to claim your clinical sovereignty and share your story with a global community fighting for root-cause medicine.`}],o={get:t=>{let e=JSON.parse(localStorage.getItem(s+t)||"null");if(!e)t==="blog_posts"?(e=r,o.set(t,e)):e=[];else if(t==="blog_posts"&&e.length<r.length){const a=new Set(e.map(n=>n.id)),i=r.filter(n=>!a.has(n.id));i.length>0&&(e=[...i,...e],o.set(t,e))}return e},set:(t,e)=>localStorage.setItem(s+t,JSON.stringify(e)),add:(t,e)=>{const a=o.get(t),i={id:Math.random().toString(36).substr(2,9),created_date:new Date().toISOString(),...e};return a.unshift(i),o.set(t,a),i}},l={entities:{BlogPost:{list:async(...t)=>o.get("blog_posts"),filter:async(...t)=>o.get("blog_posts"),get:async t=>o.get("blog_posts").find(e=>e.id===t)}}};export{l as h};
