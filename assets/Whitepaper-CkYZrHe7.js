import{j as e}from"./index-BrDF1hu9.js";import{S as t}from"./SEOMeta-f9gMhVrn.js";import{N as a,F as r}from"./Footer-D8rBPiyQ.js";import{P as i}from"./PageHero-DwipSmNS.js";import{M as o,r as n}from"./index-D1a9NqrP.js";const s=`
...
`;function u(){return e.jsxs("div",{className:"bg-obsidian min-h-screen text-white overflow-x-hidden",children:[e.jsx(t,{title:"Data Security & Privacy Whitepaper | Humanos Foundation",description:"Read the Aura hOS™ Zero-Knowledge architecture and FTC HBNR compliance documentation. Our structural approach to eradicating data breaches and preserving patient privacy.",url:"https://humanos.foundation/whitepaper"}),e.jsx(a,{}),e.jsx(i,{badge:"Compliance & Architecture",title:"Data Security &",titleAccent:"Privacy Whitepaper",subtitle:"The formal documentation of our Zero-Knowledge architecture, edge-first cryptography, and FTC HBNR BAA Exemption strategy."}),e.jsx("section",{className:"pb-28 px-4 md:px-8",children:e.jsx("div",{className:"max-w-4xl mx-auto",children:e.jsx("div",{className:"glass rounded-3xl p-6 md:p-12 border border-white/[0.04]",children:e.jsx("article",{className:"prose prose-invert prose-cyan max-w-none prose-headings:font-outfit prose-h1:text-3xl prose-h2:text-2xl prose-h2:border-b prose-h2:border-white/10 prose-h2:pb-2 prose-h2:mt-10 prose-h2:mb-6 prose-p:text-white/70 prose-p:leading-relaxed prose-li:text-white/70 prose-strong:text-white/90",children:e.jsx(o,{rehypePlugins:[n],children:s})})})})}),e.jsx(r,{})]})}export{u as default};
