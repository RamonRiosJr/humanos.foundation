import{j as e,L as p,a as m}from"./index-D8Saw1CY.js";function g({size:o=36,variant:n="full",className:d="",asLink:c=!0,wordmarkSize:f="sm"}){const a={xs:{name:"text-sm",sub:"text-[9px]"},sm:{name:"text-base",sub:"text-[10px]"},md:{name:"text-xl",sub:"text-[11px]"},lg:{name:"text-3xl",sub:"text-xs"},xl:{name:"text-4xl",sub:"text-sm"}},l=a[f]||a.sm,x=e.jsxs("svg",{width:o,height:o,viewBox:"0 0 48 48",fill:"none",xmlns:"http://www.w3.org/2000/svg",className:"flex-shrink-0 transition-transform duration-500 group-hover:scale-110 drop-shadow-none group-hover:drop-shadow-[0_0_25px_rgba(34,211,238,0.6)]","aria-label":"hOS — Human Operating System",children:[e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"hOS-grad-a",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#22d3ee"}),e.jsx("stop",{offset:"100%",stopColor:"#3b82f6"})]}),e.jsxs("linearGradient",{id:"hOS-grad-b",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#06b6d4",stopOpacity:"0.3"}),e.jsx("stop",{offset:"100%",stopColor:"#2563eb",stopOpacity:"0.15"})]}),e.jsxs("filter",{id:"hOS-glow",children:[e.jsx("feGaussianBlur",{stdDeviation:"1.5",result:"coloredBlur"}),e.jsxs("feMerge",{children:[e.jsx("feMergeNode",{in:"coloredBlur"}),e.jsx("feMergeNode",{in:"SourceGraphic"})]})]})]}),e.jsx("style",{children:`
