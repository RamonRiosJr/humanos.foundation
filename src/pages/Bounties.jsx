        ...
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden">
            ...
            <section className="py-20 px-4 md:px-8 max-w-5xl mx-auto space-y-16">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="glass p-6 rounded-3xl border border-white/5 relative overflow-hidden">
                        ...
                        <p className="text-xs text-white/50 leading-relaxed">
                            Navigate to our GitHub repositories and comment on
                            an Issue tagged with `bounty-open` to request
                            assignment. You must be formally assigned to secure
                            the commit lock and prevent collision.
                        </p>
                    </div>
                    <div className="glass p-6 rounded-3xl border border-white/5 relative overflow-hidden">
                        ...
                        <p className="text-xs text-white/50 leading-relaxed">
                            Engineer the feature or parser. Your PR must pass
                            all CI/CD mathematical checks and maintain absolute
                    ...
                    <div className="glass p-6 rounded-3xl border border-white/5 relative overflow-hidden">
                        ...
                        <p className="text-xs text-white/50 leading-relaxed">
                            Once your code is successfully squashed and merged
                            into `main`, the USD impact grant is securely
                            escrowed. Payouts are executed strictly upon
                            Institutional Endowment or Federal Grant
                            disbursement.
                        </p>
                    </div>
                </div>
                            ...
                            >
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                                    ...
                                    <div className="flex items-center justify-between sm:justify-end gap-4 min-w-max">
                                        ...
                                        <div
                                            className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border ${bounty.status === "Open" ? "bg-amber-500/10 text-amber-400 border-amber-500/20" : "bg-white/5 text-white/40 border-white/10"}`}
                                        >
                                            {bounty.status}
                                        </div>
                                    </div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {bounty.labels.map((label) => (
                                        <span
                                            key={label}
                                            className="px-2 py-1 bg-white/5 border border-white/10 rounded-md text-[10px] text-white/50"
                                        >
                                            {label}
                                        </span>
                                    ))}
                ...
                <div className="text-center">
                    <a
                        href="https://github.com/pulls?q=user%3ARamonRiosJr+is%3Aissue+is%3Aopen+label%3Abounty-open"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-cyan-500/10 border border-cyan-500/30 hover:bg-cyan-500/20 text-cyan-300 font-bold text-sm tracking-wider uppercase transition-all glow-btn"
                    >
