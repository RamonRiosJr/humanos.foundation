...
const systems = [
    {
        name: "FHIR OAuth Ingestion APIs",
        status: "Pending Link",
        uptime: "--.--%",
        icon: <Globe2 className="w-4 h-4 text-slate-500" />,
    },
    {
        name: "Zero-Knowledge Edge Relays",
        status: "Pending Link",
        uptime: "--.--%",
        icon: <Server className="w-4 h-4 text-slate-500" />,
    },
    {
        name: "Biometric Webhook Ledger",
        status: "Pending Link",
        uptime: "--.--%",
        ...
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden">
            ...
            <section className="py-20 px-4 md:px-8 max-w-4xl mx-auto space-y-12">
                ...
                <div className="p-8 rounded-3xl bg-slate-500/10 border border-slate-500/30 flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-300/80">
                            Pending Phase 17 connection to the primary Edge SLA
                            API.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    <h3 className="text-lg font-bold font-outfit text-white px-2">
                        Core Infrastructure
                    </h3>
                ...
                <div className="pt-8 border-t border-white/[0.05]">
                    <h3 className="text-lg font-bold font-outfit text-white mb-6 px-2">
                        Past 14 Days
                    </h3>
                    <div className="glass p-8 rounded-2xl border border-white/5 text-center">
                        <p className="text-sm text-white/50 leading-relaxed max-w-md mx-auto">
                            Detailed incident history logs have been temporarily
                            locked pending our migration to the new edge uptime
                            monitor in Phase 17.
                        </p>
                    </div>
                </div>
