...
const categoryColors = {
    ...
    "Research & Data":
        "text-purple-400/80 bg-purple-500/10 border-purple-500/20",
...
export default function Blog() {
    ...
    return (
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden">
            ...
            <Navbar />
            <PageHero
                badge="Aura hOS™ v0.9.1 — SOVEREIGN LIBRARY"
                title="The Movement"
                    ...
                    {loading ? (
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[...Array(6)].map((_, i) => (
                                <div
                                    key={i}
                                    className="glass rounded-2xl p-6 animate-pulse border border-white/[0.04] h-64"
                                >
                                        ...
                                        >
                                            <div className="p-6 flex flex-col h-full">
                                                <div className="flex items-center justify-between mb-4">
                                                    {post.category && (
                                                        <span
                                                            className={`text-[9px] font-bold uppercase tracking-widest px-2 py-1 rounded border ${categoryColors[post.category] || "text-white/30 bg-white/5 border-white/10"}`}
                                                        >
                                                            {post.category}
                                                        </span>
                                                    )}
                                                ...
                                                <h3
                                                    className="text-lg font-bold text-white/90 group-hover:text-white transition-colors leading-tight mb-3"
                                                    style={{
                                                        fontFamily:
