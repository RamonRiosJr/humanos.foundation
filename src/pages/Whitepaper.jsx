            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 text-center relative py-32">
                ...
                >
                    ...
                    <p className="text-white/70 mb-8 leading-relaxed font-medium">
                        To maintain strict non-profit compliance boundaries, the
                        Data Security & Privacy Whitepaper is now hosted
                        securely on the Aura hOS Sovereign Architecture.
                    </p>
                    ...
                    <div className="bg-white/[0.03] border border-white/10 rounded-xl p-5 mb-6 backdrop-blur-sm relative overflow-hidden group">
                        ...
                        <a
                            ...
                            className="text-sm text-cyan-400 group-hover:text-cyan-300 transition-colors font-medium tracking-wide flex items-center justify-center gap-2"
                        >
                            <ExternalLink className="w-4 h-4" /> Routing to
                            aurahos.io
                        </a>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <noscript>
                            <a
                                href="https://aurahos.io/whitepaper"
                                className="text-xs text-rose-400 bg-rose-500/10 border border-rose-500/20 px-4 py-2 rounded mt-2 block hover:bg-rose-500/20 transition-colors"
                            >
                        ...
                        <p className="text-[11px] text-zinc-500 italic font-normal tracking-wide bg-black/40 px-4 py-2 mt-4 rounded-lg border border-white/5 shadow-inner">
                            Aura hOS proudly donates its Sovereign Technology to
                            our patients.
                        </p>
                    </div>
                </motion.div>
