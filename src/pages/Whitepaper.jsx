...
export default function Whitepaper() {
    ...
    return (
        <div className="bg-obsidian min-h-screen text-white flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
            <SEOMeta
            ...
            >
                ...
                <div className="bg-white/[0.03] border border-white/10 rounded-xl p-5 mb-6 backdrop-blur-sm relative overflow-hidden">
                    <motion.div 
                        initial={{ x: '-100%' }}
                        animate={{ x: '100%' }}
                    ...
                    />
                    <p className="text-sm text-cyan-400/90 font-medium tracking-wide flex items-center justify-center gap-2">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-[11px] text-zinc-500 italic font-normal tracking-wide bg-black/40 px-4 py-2 mt-4 rounded-lg border border-white/5">
