...
const projects = [
    {
        name: "OpenMRS",
        desc: "Open-source medical record system for resource-constrained environments. Used in 40+ countries.",
        url: "https://openmrs.org",
        icon: Database,
    },
    {
        name: "GNU Health",
        desc: "Free health and hospital information system advocating for freedom in healthcare.",
        url: "https://www.gnuhealth.org",
        icon: Globe,
    },
    {
        name: "FHIR Community",
        desc: "The open standard for health data exchange. HL7 FHIR enables true interoperability.",
        url: "https://www.hl7.org/fhir",
        icon: Code,
    },
    {
        name: "Blue Button 2.0",
        desc: "CMS initiative giving Medicare beneficiaries access to their own claims data.",
...
const principles = [
    ...
    <span key="pr2">
        Transparency in code is{" "}
        <Link
            to={createPageUrl("Manifesto")}
            className="text-cyan-400 hover:text-cyan-300 underline underline-offset-4 decoration-cyan-400/30"
        >
            transparency in intent
        </Link>
        . We cannot trust what we cannot inspect.
    </span>,
    ...
    return (
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden">
            ...
            <PageHero
                ...
                title="Open by"
                titleAccent="Default"
                subtitle="We believe in open source as a philosophy, not just a development model. Transparency, collaboration, and freedom are how we build trust."
            />
            <section className="pb-20 px-4 md:px-8">
                <div className="max-w-5xl mx-auto space-y-16">
                    {/* Philosophy */}
                    <div>
                        <p className="text-xs text-cyan-400/50 uppercase tracking-widest font-medium mb-6">
                            Our Philosophy
                        </p>
                        <div className="space-y-4">
                            {principles.map((p, i) => (
                                <motion.div
                                    ...
                                    className="flex items-start gap-4 glass rounded-2xl p-5 border border-white/[0.04]"
                                >
                                    <span className="text-cyan-500/30 font-mono text-sm shrink-0 mt-0.5">
                    ...
                    <div>
                        <p className="text-xs text-cyan-400/50 uppercase tracking-widest font-medium mb-6">
                            Open Source Health Projects We Respect
                        </p>
                        <div className="grid sm:grid-cols-2 gap-4">
                            {projects.map((proj, i) => (
                                <motion.a
                                    ...
                                    className="glass rounded-2xl p-6 border border-white/[0.04] hover:border-cyan-500/20 transition-all duration-400 group flex items-start gap-4"
                                >
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="glass-strong rounded-3xl p-8 md:p-10 border border-cyan-500/10 text-center"
                    >
                        <Github className="w-10 h-10 text-white/30 mx-auto mb-4" />
                        <h3
                            className="text-xl font-bold text-white/70 mb-2"
                            style={{ fontFamily: "Outfit, Inter, sans-serif" }}
                        >
                            RamonRios.Net
                        </h3>
                        <p className="text-sm text-white/30 mb-6 max-w-md mx-auto">
                            The technical home of the hOS movement. Open source,
                            community-driven, patient-first.
                        </p>
                        <a
                            href="https://ramonrios.net"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl glass border border-white/[0.08] text-sm text-white/50 hover:text-cyan-400 hover:border-cyan-500/30 transition-all"
                        >
                            Visit RamonRios.Net{" "}
