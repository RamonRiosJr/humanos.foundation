...
const principles = [
    {
        ...
        description: (
            <span>
                Every design decision, every technical tradeoff, every business
                decision begins with one question:{" "}
                <span className="text-cyan-400/80 font-medium">
                    does this serve the patient?
                </span>{" "}
                Not the hospital. Not the insurer. Not the investor. The
                patient.
            </span>
        ),
    ...
    },
    {
        ...
        description: (
            <span key="p3">
                Health data should live on the device you own,{" "}
                <span className="text-cyan-400/80 font-medium">
                    not on a server you don't control
                </span>
                .{" "}
                <Link
                    to={createPageUrl("Glossary")}
                ...
                means you stay in control even when you're offline, even when
                companies shut down.
            </span>
        ),
    ...
    },
    {
        ...
        description: (
            <span>
                Every read of your data is logged inside the hOS boundary.
                However, once you grant a clinician temporary access to your
                records, they may ingest that data into their own legacy
                systems. hOS does not control the{" "}
                <span className="text-cyan-400/80 font-medium">
                    institutional silos
                </span>{" "}
                where your data is subsequently stored or shared; our mission is
                to ensure you know exactly what left your vault and when.
            </span>
        ),
        ...
        description: (
            <span key="p5">
                <Link
                    ...
                    className="text-cyan-400 hover:text-cyan-300 underline underline-offset-4 decoration-cyan-400/30 transition-colors"
                >
                    We advocate for open health data standards
                </Link>{" "}
                (FHIR, HL7) that allow your data to{" "}
                <span className="text-cyan-400/80 font-medium">
                    move freely between systems
                </span>
                . No lock-in. No proprietary format that holds your health
                record hostage.
            </span>
        ),
    ...
    },
    {
        ...
        description: (
            <span>
                ...
                must reach underserved communities, low-income populations, and
                the Global South. Health equity is a design requirement, not an
                afterthought.
            </span>
        ),
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-5 md:gap-10">
                                ...
                                <div className="flex-1">
                                    <div className="flex flex-col md:flex-row md:items-center gap-2 mb-2">
                                        ...
                                        <span className="text-xs text-cyan-400/40 md:before:content-['—'] md:before:mr-2 italic">
                                            {p.tagline}
                                        </span>
                                    </div>
