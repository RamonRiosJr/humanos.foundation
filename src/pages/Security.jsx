    ...
    return (
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden">
            ...
            <PageHero
                badge="Security"
                title="Responsible"
                titleAccent="Disclosure"
                subtitle="We take security seriously. If you've found a vulnerability, we want to know — and we'll treat you with respect."
            />
            ...
            <section className="pb-28 px-4 md:px-8">
                <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="glass-strong rounded-3xl p-8 md:p-12 border border-cyan-500/10 text-center"
                    >
                        <Shield className="w-12 h-12 text-cyan-400/60 mx-auto mb-5" />
                        <h2
                            className="text-xl font-bold text-white/70 mb-3"
                            style={{ fontFamily: "Outfit, Inter, sans-serif" }}
                        >
                            Found a Vulnerability?
                        </h2>
                        <p className="text-sm text-white/60 mb-6 max-w-md mx-auto">
                            Please report it responsibly. We appreciate the
                            security community's work in keeping our{" "}
                            <span className="text-cyan-400 font-bold">
                                systems safe.
                            </span>
                        </p>
                        <a
                            href="mailto:security@humanos.foundation"
                    ...
                    <motion.div
                        ...
                        className="glass rounded-3xl p-8 border border-white/[0.04]"
                    >
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        ...
                        <motion.div
                            ...
                            className="glass rounded-2xl p-6 border border-white/[0.04]"
                        >
                            <p className="text-xs text-cyan-400/50 uppercase tracking-widest mb-4">
                                In Scope
                            </p>
                            <ul className="space-y-2">
                                {inScope.map((item, i) => (
                                    ...
                                    >
                                        <span className="text-cyan-500/30 mt-0.5">
                                            ·
                                        </span>
                                        {item}
                                    </li>
                        ...
                        <motion.div
                            ...
                            className="glass rounded-2xl p-6 border border-white/[0.04]"
                        >
                            <p className="text-xs text-amber-400/50 uppercase tracking-widest mb-4">
                                Out of Scope
                            </p>
                            <ul className="space-y-2">
                    ...
                    >
                        <p className="text-sm text-white/60 leading-relaxed">
                            ...
                            Security researchers act in the{" "}
                            <span className="text-cyan-400/80 font-medium">
                                public interest.
                            </span>{" "}
                            We will never sue, threaten, or take action against
                            someone who follows responsible disclosure
                            practices. We believe security research is a{" "}
                            <span className="text-cyan-400/80 font-medium">
                                public good
                            </span>
