...
const values = [
    {
        ...
        description: (
            <span>
                Every decision starts with one question: does this{" "}
        ...
        description: (
            <span key="v2">
                <Link
                    ...
                    className="text-cyan-400 font-bold hover:text-cyan-300 underline underline-offset-4 decoration-cyan-400/40 drop-shadow-[0_0_8px_rgba(34,211,238,0.2)]"
                >
                    Data ownership is not a feature
                </Link>{" "}
                — it's the foundation.
            </span>
        ),
        ...
        description: (
            <span key="v3">
                <Link
                    ...
                    className="text-cyan-400 font-bold hover:text-cyan-300 underline underline-offset-4 decoration-cyan-400/40"
                >
                    Transparency in code
                </Link>
                , governance, and intention.
            </span>
        ),
    },
    {
    ...
    },
    {
        ...
        description: (
            <span>
                No jargon. No obscurity. Your health record should be{" "}
                <span className="text-cyan-400/80 font-bold">
                    readable by you
                </span>
                .
    ...
    },
    {
        ...
        description: (
            <span>
                This is a{" "}
                <span className="text-cyan-400/80 font-bold">movement</span>,
                not a startup. We grow through{" "}
                <span className="text-cyan-400/80 font-bold">people</span>, not
                press releases.
            </span>
        ),
    },
    ...
    return (
        <section ref={ref} className="py-20 md:py-28 px-4 md:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <span className="text-xs text-cyan-400 font-bold tracking-[0.2em] uppercase drop-shadow-[0_0_8px_rgba(34,211,238,0.2)]">
                        What We Stand For
                    </span>
                    <h2
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-5">
                    {values.map((v, i) => (
                        ...
                        >
                            ...
                            >
                                <v.icon
                                    className={`w-5 h-5 ${v.color} mb-4 group-hover:scale-110 transition-transform duration-300`}
                                />
                            </motion.div>
                            <h3
                                className="text-base font-bold text-white/90 mb-2"
                                style={{
