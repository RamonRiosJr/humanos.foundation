...
const declarations = [
    ...
    <span>We declare that the current medical architecture is driven by <span className="text-cyan-400/80 font-bold">legacy data constraints</span>, designed to rapidly process patient volume rather than expose complex, <span className="text-cyan-400/80 font-bold">root-cause pathology</span>.</span>,
    <span key="d3">We declare an end to the "prescriptive spiral" — the systemic pattern of <Link to={createPageUrl('TheProblem')} className="text-cyan-400 hover:text-cyan-300 underline underline-offset-4 decoration-cyan-400/30 transition-colors font-medium">treating isolated symptoms due to time constraints</Link> rather than healing the human.</span>,
    <span key="d4">We refuse to suffer the <span className="text-cyan-400/80 font-bold">15-20 page clipboard penalty</span>, only for our profound physical and mental realities to be ignored in a <Link to={createPageUrl('Principles')} className="text-cyan-400 hover:text-cyan-300 underline underline-offset-4 decoration-cyan-400/30 transition-colors font-medium">rushed 5-minute clinical documentation</Link>.</span>,
    <span>We demand systems that capture our <span className="text-cyan-400/80 font-medium">continuous, unbroken truth</span> — bridging the First Mile with irrefutable data before we ever step foot in a clinic.</span>,
...
const fourLaws = [
    { icon: Eye, number: 'I', title: 'The Law of Lived Experience', color: 'text-blue-400', description: <span>Your health history is <span className="text-cyan-400/80 font-medium">continuous, not episodic</span>. The system must adapt to your continuous reality, rather than forcing you to compress your suffering into the <span className="text-cyan-400/80 font-medium">15-20 page clipboard penalty</span> and a rushed 5-minute clinical documentation.</span> },
    { icon: Shield, number: 'II', title: 'The Law of Root Cause', color: 'text-purple-400', description: <span>You have the right to <span className="text-cyan-400/80 font-medium">clinical diligence</span>. Treating isolated symptoms with an ever-expanding prescriptive spiral while ignoring the root cause is an architectural failure of care.</span> },
    { icon: Key, number: 'III', title: 'The Law of Sovereignty', color: 'text-amber-500', description: <span>Your data belongs to you. By controlling the <span className="text-cyan-400/80 font-medium">highest fidelity, most unignorable health graph</span> of your own life, you force the system to treat you as an individual. Be warned: sovereignty ends where the clinic begins. <a href="https://aurahos.io/whitepaper" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline underline-offset-4 decoration-cyan-400/30 transition-colors font-medium">Read the Zero-Knowledge Whitepaper.</a><span className="block mt-2 text-[11px] text-zinc-500 italic font-normal tracking-wide bg-obsidian/50 p-2 rounded border border-white/5 inline-block">Aura hOS proudly donates its mathematics to our patients.</span></span> },
    { icon: Scale, number: 'IV', title: 'The Law of Independence', color: 'text-emerald-400', description: <span>Technology must <span className="text-cyan-400/80 font-medium">serve the patient first</span>—not the administrative backlog, not the legacy silo, and not institutional convenience. We build tools that make you the undeniable center of your care.</span> },
];
