            ...
            <section className="py-20 px-4 md:px-8 max-w-5xl mx-auto space-y-16">
                ...
                <div className="glass p-8 md:p-12 rounded-3xl border border-white/10">
                    <div className="flex items-center gap-4 mb-8 pb-6 border-b border-white/[0.05]">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/50">
                                Strict HTTP/REST stateless execution over
                    ...
                    <p className="text-sm text-white/70 leading-relaxed mb-6">
                        Unlike traditional clinical software, you do not need to
                        install local databases or secure HIPAA pipelines. You
                        simply strip all PII and format the anonymized clinical
                        telemetry into an isolated{" "}
                        <code className="text-cyan-300 font-mono text-[10px] bg-cyan-500/10 px-1 rounded">
                            JSON FHIR R4
                        </code>{" "}
                        standard and `POST` it to our ephemeral edge proxy along
                        with your <code>Clinic Routing ID</code>.
                    </p>
                    ...
                    <div className="bg-[#0a0a0f] rounded-xl border border-white/5 overflow-hidden">
                        <div className="bg-white/[0.02] px-4 py-2 flex items-center gap-2 border-b border-white/5">
                            ...
                            <span className="text-[10px] text-white/30 ml-2 font-mono uppercase tracking-wider">
                                aurahos.io/api/edge/fhir-dispatcher
                            </span>
                        </div>
                        <div className="p-6 overflow-x-auto text-xs font-mono text-cyan-300/80 leading-relaxed">
                            <span className="text-purple-400">POST</span>{" "}
                            <span className="text-white/60">
                                /api/edge/fhir-dispatcher
                            </span>
                            <br />
                            <span className="text-blue-400">
                                Authorization:
                            </span>{" "}
                            Bearer {"<"}YOUR_AURA_SECRET{">"}
                            <br />
                            <span className="text-blue-400">
                                Content-Type:
                            </span>{" "}
                            ...
                            <span className="text-white/40">: {"{"}</span>
                            <br />
                            <span className="text-rose-300"> "coding"</span>
                            <span className="text-white/40">: [{"{"} </span>
                            <span className="text-rose-300">"system"</span>
                            <span className="text-white/40">:</span>{" "}
                            <span className="text-emerald-300">
                                "http://loinc.org"
                            </span>
                            ...
                            <span className="text-rose-300">"code"</span>
                            <span className="text-white/40">:</span>{" "}
                            <span className="text-emerald-300">"8310-5"</span>{" "}
                            <span className="text-white/40">{"}"}]</span>
                            <br />
                            <span className="text-white/40"> {"}"},</span>
                            <br />
                            ...
                            <span className="text-white/40">:</span>{" "}
                            <span className="text-purple-400">36.6</span>
                            <span className="text-white/40">,</span>{" "}
                            <span className="text-rose-300">"unit"</span>
                            <span className="text-white/40">:</span>{" "}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <a
                        href="https://github.com/Humanos-OS/aura-health-os"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="glass p-6 rounded-3xl border border-white/5 hover:border-cyan-500/30 transition-all group"
                    >
                        ...
                        <h3 className="text-lg font-bold text-white mb-2">
                            Aura Health OS (Mobile App)
                        </h3>
                        <p className="text-sm text-white/50 leading-relaxed">
                            The React Native logic running natively on the
                            patient's device, handling the AES-256 decryption
                            and biometrics.
                        </p>
                    </a>

                    <a
                        href="https://github.com/Humanos-OS/aura-hub"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="glass p-6 rounded-3xl border border-white/5 hover:border-cyan-500/30 transition-all group"
                    >
                        ...
                        <h3 className="text-lg font-bold text-white mb-2">
                            Aura Hub (Backend & Edges)
                        </h3>
                        <p className="text-sm text-white/50 leading-relaxed mb-4">
                            The Supabase Deno Edge functions managing the secure
                            webhook routes, powering the interoperable Sovereign
                            Technology.
                        </p>
