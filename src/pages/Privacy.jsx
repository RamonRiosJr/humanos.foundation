...
const sections = [
    ...
    {
        title: "2. FTC HBNR & Zero-Knowledge Architecture",
        content: `The Humanos Foundation explicitly operates outside the scope of the FTC Health Breach Notification Rule (HBNR) and HIPAA Business Associate Agreements (BAA) because of our architectural design.\n\nWe utilize a mathematically verifiable Zero-Knowledge client-side encryption model for the Aura hOS application. We do not have access to, nor the ability to decrypt, your Personal Health Records (PHR) or electronic health records (EHR). No identifiable clinical data reaches our server infrastructure in an unencrypted, readable format. Therefore, we do not possess nor share any actionable health data.`,
    },
    {
        title: "3. Information We Collect (Website Only)",
    ...
    {
        title: "5. Data Storage & Third Parties",
    ...
    return (
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden">
            ...
            <PageHero
                ...
                title="Privacy"
                titleAccent="Policy"
                subtitle="We believe in radical transparency — including about how we handle your data."
            />
            <LegalLayout
                sections={sections}
