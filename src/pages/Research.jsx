...
import { Network, LineChart, TestTube2, ShieldCheck, Activity, Users, Clock, Database, Lock, Fingerprint, Zap, ServerOff, Cpu } from 'lucide-react';
    ...
    return (
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden selection:bg-cyan-500/30">
            ...
            <section className="py-12 px-4 md:px-8 max-w-6xl mx-auto space-y-24">
                ...
                >
                    {[
                        { label: "Active Cohort Size", value: "2,841", icon: Users, color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/20" },
                        { label: "Zero-Knowledge Packets", value: "1.2M+", icon: Lock, color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20" },
                        { label: "Avg. Adherence Lift", value: "+38.4%", icon: LineChart, color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/20" },
                        { label: "Current Network Latency", value: "< 12ms", icon: Zap, color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/20" }
                    ].map((stat, i) => (
                        <div key={i} className={`p-6 rounded-3xl border ${stat.border} ${stat.bg} backdrop-blur-md relative overflow-hidden group`}>
                            ...
                            <p className="text-3xl md:text-4xl font-bold font-outfit text-white mb-1">{stat.value}</p>
                            <p className="text-[10px] md:text-xs text-white/60 uppercase tracking-widest font-bold">{stat.label}</p>
                        </div>
                    ))}
                </motion.div>
                ...
                <div className="space-y-16">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-sm font-bold uppercase tracking-widest text-white/50 text-center">Active Pipeline Protocols</h2>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-start md:items-center justify-between mb-6 flex-col md:flex-row gap-4">
                                <h2 className="text-2xl md:text-4xl font-bold font-outfit text-white">Neurodivergent UI Sovereignty vs. Adherence Rates</h2>
                                <NativeShareWidget 
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-10">
                                <div className="p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
                                    <h4 className="text-xs font-bold text-white/50 uppercase tracking-widest mb-4 border-b border-white/5 pb-3">The Control Paradigm</h4>
                                    <p className="text-sm text-white/70 leading-relaxed">
                                        Current EHR portals (e.g., MyChart) are digital manifestations of the 15-20 page clipboard penalty. For neurodivergent populations (ADHD/Autism spectrums), this clinical friction and the resulting compressed 5-minute clinical documentation trigger severe executive dysfunction, directly resulting in an average <strong className="text-red-400">40% medication non-adherence rate</strong>.
                                    </p>
                                </div>
                                <div className="p-6 rounded-2xl bg-cyan-500/5 border border-cyan-500/20 shadow-[0_0_30px_rgba(34,211,238,0.05)]">
                                    <h4 className="text-xs font-bold text-cyan-400/80 uppercase tracking-widest mb-4 border-b border-cyan-500/20 pb-3">The Experimental Paradigm</h4>
                            ...
                            <div className="p-5 rounded-2xl bg-[#0a0a0f] border border-white/5 flex flex-col sm:flex-row items-center gap-6 justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-white/50 uppercase tracking-wider">2,500 Pediatric Handshakes</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-white/50 uppercase tracking-wider">90-Day Rx Adherence Lift</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-start md:items-center justify-between mb-6 flex-col md:flex-row gap-4">
                                <h2 className="text-2xl md:text-4xl font-bold font-outfit text-white">Zero-Knowledge SQLite vs Cloud Latency in Rural Geographies</h2>
                                <NativeShareWidget 
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-10">
                                <div className="space-y-4">
                                    <p className="text-sm text-white/70 leading-relaxed">
                                        Vast geographic swaths of marginalized populations suffer from <strong>"Broadband Redlining."</strong> Cloud-native EHR systems fundamentally fail in these environments, severing maternal and pediatric care pathways during critical network dropouts.
                                    </p>
                                    <p className="text-sm text-white/70 leading-relaxed">
                                        We hypothesize that deploying an <strong>Offline-First, Zero-Knowledge SQLite</strong> architecture on patient-owned devices will drastically reduce care interruption events and eliminate latency-driven patient abandonment in rural clinical settings.
                                    </p>
                                </div>
                                <div className="bg-[#0a0a0f] rounded-2xl border border-white/5 p-6 flex flex-col justify-center">
                                    <div className="flex items-center gap-3 mb-6">
                                        <Database className="w-5 h-5 text-amber-400" />
                                        <span className="text-xs font-bold text-white uppercase tracking-widest">Architectural Advantage</span>
                                    </div>
                                    <ul className="space-y-4">
                                        <li className="flex items-center justify-between border-b border-white/5 pb-3">
                                            <span className="text-xs text-white/60">Cloud Dependency</span>
                                            <span className="text-xs font-bold text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded">0%</span>
                                        </li>
                                        <li className="flex items-center justify-between border-b border-white/5 pb-3">
                                            <span className="text-xs text-white/60">Data Portability</span>
                                            <span className="text-xs font-bold text-cyan-400 bg-cyan-500/10 px-2 py-1 rounded">100% Secure</span>
                                        </li>
                                        <li className="flex items-center justify-between">
                                            <span className="text-xs text-white/60">Offline Mutation Sync</span>
                                            <span className="text-xs font-bold text-amber-400 bg-amber-500/10 px-2 py-1 rounded">Event-Sourced</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-start md:items-center justify-between mb-6 flex-col md:flex-row gap-4">
                                <h2 className="text-2xl md:text-4xl font-bold font-outfit text-white">Somatic Biometric Syncing vs. Acute Pediatric Anxiety</h2>
                                <NativeShareWidget 
                            ...
                            <p className="text-sm text-white/70 leading-relaxed max-w-3xl mb-8">
                                White-coat syndrome and clinical environmental triggers artificially inflate vital signs, specifically heart rate and blood pressure, during pediatric intake. By allowing patients to ingest their own continuous wearable telemetry directly into their sovereign vault prior to the visit, we seek to prove a reduction in medically induced anxiety markers.
                            </p>

                            <div className="p-6 rounded-2xl bg-[#0a0a0f] border border-white/5 relative overflow-hidden">
                                <div className="flex items-center gap-3 mb-4 relative z-10">
                                    <Cpu className="w-5 h-5 text-rose-400" />
                                    <span className="text-xs font-bold text-white uppercase tracking-widest">Live Telemetry Simulation</span>
                                </div>
                                <HeartbeatStream color="#fb7185" duration={2.5} className="opacity-80" />
                                <div className="absolute top-6 right-6 z-10 bg-rose-500/10 border border-rose-500/30 px-3 py-1 rounded-full flex items-center gap-2">
                                    ...
                                    <span className="text-[10px] font-bold text-rose-400 uppercase">Vagal Tone Active</span>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                ...
                >
                    <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between mb-12">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl md:text-3xl font-bold font-outfit text-white">Full Clinical Protocol & Methodology</h3>
                                <p className="text-sm text-white/50 mt-1">Regulatory bounds and IRB zero-knowledge exemptions.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                            <div className="p-6 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/[0.07] transition-colors">
                                <h4 className="flex items-center gap-3 text-sm font-bold text-white mb-5">
                                    <Fingerprint className="w-4 h-4 text-cyan-400" /> Specific Aims & Mechanics
                                </h4>
                                <ul className="space-y-4 text-sm text-white/60">
                                    <li className="flex items-start gap-3">
                                        <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 shrink-0 shadow-[0_0_8px_rgba(34,211,238,0.8)]" />
                                        <p><strong className="text-white/90">Objective:</strong> Quantify the mathematical lift in pharmacological adherence (Rx fills) when compliance-driven UI barriers (2FA resets, generic notifications) are removed via localized FHIR interception.</p>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 mt-2 shrink-0 shadow-[0_0_8px_rgba(34,211,238,0.8)]" />
                                        <p><strong className="text-white/90">Data Capture Mechanics:</strong> Real-time Rx refill rates are ingested securely via encrypted e-prescribing webhooks locally. There is NO reliance on unreliable patient self-reporting.</p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="p-6 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/[0.07] transition-colors">
                                ...
                                <ul className="space-y-4 text-sm text-white/60">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <p><strong className="text-white/90">Criteria:</strong> Patients aged 8-17, formally navigating ASD/ADHD neurodivergence, currently requiring daily pharmacological intervention (e.g., Stimulants, SSRIs).</p>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0 shadow-[0_0_8px_rgba(248,113,113,0.8)]" />
                                        <p><strong className="text-white/90">Exclusions:</strong> Patients requiring active inpatient psychiatric monitoring or severe acute intervention, to maintain pure outpatient executive function logging.</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
                                ...
                                <div className="space-y-6">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-white">Phase I (Months 1-3)</p>
                                            <p className="text-xs text-white/50 mt-1">Baseline UI friction logging and cohort onboarding via NGO routes.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="flex flex-col items-center mt-1">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-white">Phase II (Months 4-6)</p>
                                            <p className="text-xs text-white/50 mt-1">Aura hOS continuous zero-friction Rx routing deployment.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4">
                                        <div className="flex flex-col items-center mt-1">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-white">Phase III (Months 7-12)</p>
                                            <p className="text-xs text-white/50 mt-1">Quantitative evaluation of adherence lift and Federal Grant reporting.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        <div>
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <h4 className="text-sm font-bold text-red-400 uppercase tracking-widest">Institutional Advisory Mandate</h4>
                            </div>
                        ...
                        <a href="mailto:hello@humanos.foundation" className="shrink-0 px-8 py-3 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/30 font-bold text-xs uppercase tracking-widest rounded-xl transition-all duration-300 whitespace-nowrap shadow-[0_0_20px_rgba(239,68,68,0.1)] hover:shadow-[0_0_30px_rgba(239,68,68,0.2)]">
                            Apply for PI Role
                        </a>
                    </motion.div>
                </motion.div>
