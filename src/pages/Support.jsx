...
const supportWays = [
    ...
    { icon: DollarSign, title: 'Financial Support', desc: 'Our engineering framework is strictly structured for institutional and federal pathways. The $825k federal health equity grant serves as our bridge to sustainably fund the open source architecture.', cta: 'View Research', href: '/research' },
];

export default function Support() {
    return (
        <div className="bg-obsidian min-h-screen text-white overflow-x-hidden">
            <SEOMeta title="Support the Movement — Donate & Contribute to hOS" description="Support Humanos Foundation's mission for patient data sovereignty. Volunteer, contribute code, spread the word, or explore our research roadmap. Every contribution fuels the revolution." url="https://humanos.foundation/support" />
            <Navbar />
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="mt-10 glass rounded-2xl p-6 border border-yellow-500/20 text-center">
                        <p className="text-sm text-white/60 leading-relaxed">
                            <span className="text-yellow-400 font-bold">Philanthropic Capitalization:</span>{' '}
                            Humanos Foundation operates its core development via fully transparent movement mechanics. While formal 501(c)(3) nonprofit status is pending, our core infrastructure pipeline structurally targets the $825k federal health equity pilot to fund the open source repository.
                        </p>
                    </motion.div>
                </div>
            </section>
