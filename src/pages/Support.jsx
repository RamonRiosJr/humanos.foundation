...
const supportWays = [
    ...
    { icon: DollarSign, title: 'Financial Support', desc: 'Our engineering framework is strictly structured for institutional and federal pathways. The $825k PCORI / AHRQ non-dilutive pilot application serves as our bridge to the upcoming $1.5M Seed Round.', cta: 'View Research', href: '/research' },
];
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="mt-10 glass rounded-2xl p-6 border border-yellow-500/20 text-center">
                        <p className="text-sm text-white/60 leading-relaxed">
                            ...
                            Humanos Foundation operates its core development via enterprise capital mechanics. While formal 501(c)(3) nonprofit status is pending, our core B2B infrastructure pipeline structurally targets the $825k PCORI / AHRQ pilot into our $1.5M Seed Round.
                        </p>
                    </motion.div>
                </div>
            </section>
