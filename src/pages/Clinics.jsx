                ...
                <div className="mb-12 p-6 glass rounded-2xl border border-blue-500/20 bg-blue-500/5 flex gap-4 items-start">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-white mb-2">
                            How to Use Clinic IDs
                        </h3>
                        <p className="text-sm text-white opacity-70 leading-relaxed">
                            Aura hOS establishes a Zero-Knowledge architectural
                            handshake between your encrypted local vault and a
                            provider. When you arrive at a participating clinic,
                            input their verified routing ID below into your Aura
                            app to establish a secure, ephemeral data bridge. No
                            SSN required.
                        </p>
                    </div>
                </div>
                    ...
                    {clinicDirectory.map((clinic, index) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div
                                    className={`px-2 py-1 rounded text-[10px] font-bold tracking-wider uppercase ${clinic.status.includes("Active") ? "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" : "bg-amber-500/10 text-amber-400 border border-amber-500/20"}`}
                                >
                                    {clinic.status}
                                </div>
                            </div>
                            ...
                            <p className="text-xs text-white opacity-50 mb-6">
                                {clinic.region}
                            </p>

                            <div className="space-y-3">
                                <div className="flex items-center justify-between text-sm">
                                    <span className="text-white opacity-40 flex items-center gap-2">
                                        <Key className="w-3 h-3" /> Routing ID
                                    </span>
                                ...
                                <div className="flex items-center justify-between text-sm">
                                    <span className="text-white opacity-40 flex items-center gap-2">
                                        <ShieldCheck className="w-3 h-3" /> Type
                                    </span>
                                    <span className="text-white opacity-80 text-xs font-medium">
                                        {clinic.integrationType}
                                    </span>
                                </div>
                            </div>
                        </motion.div>
