...
const governanceDocs = [
    {
        ...
        date: "2026",
        status: "Filed - State of Utah",
        icon: <Landmark className="w-4 h-4" />,
    },
    {
        title: "501(c)(3) IRS Determination",
        date: "Pending",
        status: "Awaiting Form 1023",
    ...
    {
        title: "Form 990 Public Disclosures",
        date: "---",
        status: "First filing due 2027",
            ...
            <section className="py-20 px-4 md:px-8 max-w-5xl mx-auto space-y-16">
                ...
                <div className="glass p-8 md:p-12 rounded-3xl border border-white/5">
                    ...
                    <p className="text-sm text-white/70 leading-relaxed mb-6">
                        The Humanos Foundation software architecture governs the
                        most sensitive telemetry of the human condition. To
                        prevent corporate capture and aggressive data
                        monetization, the Foundation utilizes an independent
                        Board of Directors.
                    </p>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-white mb-2">
                                    Zero-Compromise Conflict of Interest (COI)
                                    Policy
                                </h4>
                                <p className="text-xs text-white/60 leading-relaxed">
                                    No member of the Humanos Foundation Board of
                                    Directors, executive staff, or primary
                                    engineering team may hold concurrent equity
                                    in any entity that profits from the
                                    unauthorized sale, brokerage, or aggregation
                                    of patient de-identified data.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-8 rounded-3xl bg-blue-900/20 border border-blue-500/20 text-center">
                    ...
                    <p className="text-sm text-white/60 max-w-2xl mx-auto leading-relaxed">
                        To maintain strict institutional independence, any
                        future funds rendered by Federal Health Equity mandates
                        are required to be ring-fenced entirely for the
                        open-source clinical engineering of Aura hOS. Operating
                        bylaws strictly dictate that no foundational funds may
                        be allocated to marketing, lobbying, or external
