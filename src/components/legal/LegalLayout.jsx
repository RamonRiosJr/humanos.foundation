                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        {sections.map((s, i) => (
                            ...
                            >
                                <h3
                                    className="text-base font-semibold text-white/70 mb-4"
                                    style={{
                                ...
                                <div className="space-y-2">
                                    {s.content.split("\n").map((line, j) =>
                                        line.trim() === "" ? (
                                            ...
                                            <p
                                                key={j}
                                                className={`text-sm leading-relaxed ${line.startsWith("•") ? "text-white/60 pl-4 font-medium" : line === line.toUpperCase() && line.length > 20 ? "text-cyan-400 font-bold text-xs" : "text-white/60"}`}
                                            >
                                                {line}
                                            </p>
                                        ),
