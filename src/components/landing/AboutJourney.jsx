                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p className="text-white/80 text-sm md:text-base leading-relaxed font-medium">
                                ...
                                healthcare system, drowning in the <Link to={createPageUrl('TheProblem')} className="text-cyan-400/80 font-bold underline decoration-cyan-400/20">15-20 page clipboard penalty</Link>, and locked out of his own <a href="https://aurahos.io/whitepaper" target="_blank" rel="noopener noreferrer" className="text-cyan-400/80 font-bold underline decoration-cyan-400/20">Zero-Knowledge Vault</a>. <span className="block mt-3 mb-1 text-[11px] text-zinc-500 italic font-normal tracking-wide bg-obsidian/50 p-2 rounded border border-white/5 inline-block">Aura hOS proudly donates its Enterprise Architecture to our patients.</span>
