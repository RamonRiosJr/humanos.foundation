                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p className="text-white/80 text-sm md:text-base leading-relaxed font-medium">
                                ...
                                healthcare system, drowning in the <Link to={createPageUrl('TheProblem')} className="text-cyan-400/80 font-bold underline decoration-cyan-400/20">15-20 page clipboard penalty</Link>, and subjected to the failure of the rushed 5-minute clinical documentation.
                                With raw code and relentless determination, he built the absolute foundation
                                of what would become the <span className="text-cyan-400 font-bold drop-shadow-[0_0_8px_rgba(34,211,238,0.2)]">Aura hOS™</span> ecosystem. Engineered by the Humanos NGO, it is a secure, digital vault built to ensure that no patient ever has to beg for their own medical history again.
                            </p>
                            <p className="text-white/80 text-sm md:text-base leading-relaxed font-medium">
