                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p className="text-white/80 text-sm md:text-base leading-relaxed font-medium">
                                ...
                                healthcare system, dismantling the <Link to={createPageUrl('TheProblem')} className="text-cyan-400/80 font-bold underline decoration-cyan-400/20">federal CMS "Kill the Clipboard" penalty via Zero-Knowledge FHIR Edge Routing</Link> and finally unsealing the structural <a href="https://aurahos.io/whitepaper" target="_blank" rel="noopener noreferrer" className="text-cyan-400/80 font-bold underline decoration-cyan-400/20">Data Vault</a>. <span className="block mt-3 mb-1 text-[11px] text-zinc-500 italic font-normal tracking-wide bg-obsidian/50 p-2 rounded border border-white/5 inline-block">Aura hOS proudly donates its Sovereign Technology to our patients.</span>
                                With raw code and relentless determination, he built the absolute foundation
                                of what would become <span className="text-cyan-400 font-bold drop-shadow-[0_0_8px_rgba(34,211,238,0.2)]">Aura hOS™ v0.8.0-rc.4</span>. Engineered by the Humanos NGO, it now operates as an absolute digital sanctuary, giving patients the definitive power to link their health data securely <Link to={createPageUrl('Clinics')} className="text-cyan-400/80 font-bold underline decoration-cyan-400/20">without exposing their SSN</Link>.
                            </p>
                            <p className="text-white/80 text-sm md:text-base leading-relaxed font-medium">
