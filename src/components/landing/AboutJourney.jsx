                ...
                <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-center">
                                ...
                                <div className="absolute inset-0 p-6 md:p-10 flex flex-col justify-between">
                                    ...
                                    >
                                        <div className="glass rounded-lg p-4 border border-cyan-500/10">
                                            <div className="flex items-center gap-2 mb-3">
                                                ...
                                                <span className="text-[9px] text-foreground/20 ml-2 font-mono">
                                                    hOS-core.ts
                                                </span>
                                            </div>
                                    ...
                                    <div className="absolute bottom-6 left-6 md:bottom-8 md:left-10 flex items-center gap-3">
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] text-foreground/20 font-light italic">
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <p className="text-foreground/35 text-sm md:text-base leading-relaxed">
                        ...
                        {/* Principles */}
                        <div className="space-y-3 pt-4 border-t border-foreground/[0.04]">
                            {[
                                ...
                                >
                                    ...
                                    <span className="text-xs text-foreground/40">{item.text}</span>
                                </motion.div>
                            ))}
                        </div>
                    </motion.div>
