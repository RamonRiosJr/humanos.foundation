...
export default function SurvivalBanner() {
    ...
    const isSovereignRoute =
        ["/providers", "/clinics", "/sandbox", "/developers"].some((p) =>
            location.pathname.toLowerCase().includes(p),
        ) || location.search.includes("context=sovereign");
                    ...
                    <div className="flex items-center gap-4 text-center sm:text-left">
                        ...
                        <div>
                            <h3 className="text-sm md:text-base font-bold text-white mb-0.5 tracking-tight flex items-center justify-center sm:justify-start gap-2">
                                <span className="text-cyan-400 uppercase tracking-widest text-[10px] sm:text-xs">
                                ...
                                <span>
                                    Zero-Knowledge Patient Infrastructure
                                </span>
                            </h3>
                            <p className="text-xs md:text-sm text-white/70 leading-snug">
                                Aura hOS relies on mathematical integrity.
                                Sovereign payload routes are heavily encrypted
                                and directly utilize the Zero-Knowledge Vault
                                architecture.
                            </p>
                        </div>
                    </div>
        ...
        >
            ...
            <div className="absolute inset-0 opacity-10 pointer-events-none">
                ...
                >
                    <polyline
                        ...
                        stroke="#ef4444"
                        strokeWidth="1"
                        points="0,50 20,50 25,20 35,80 40,50 100,50"
                    >
                        <animate
            ...
            <div className="max-w-7xl mx-auto px-4 py-3 md:py-4 relative z-10 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4 text-center sm:text-left">
                    ...
                    <div>
                        <h3 className="text-sm md:text-base font-bold text-white mb-0.5 tracking-tight flex items-center justify-center sm:justify-start gap-2">
                            <span className="text-red-400 uppercase tracking-widest text-[10px] sm:text-xs">
                                Federal Health Equity
                            </span>
                            <span className="hidden sm:inline text-white/30">
                                •
                            </span>
                            <span>
                                Advocacy Anchored by Federal Health Equity Pilot
                            </span>
                        </h3>
                        <p className="text-xs md:text-sm text-white/70 leading-snug">
                            Our advocacy is driven by federal health equity
                            mandates, serving as a direct institutional anchor
                            to permanently protect the Zero-Knowledge patient
