                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <a
                            ...
                            className="text-[11px] text-cyan-500/40 hover:text-cyan-400 transition-colors flex items-center gap-1"
                        >
                            humanos.foundation{" "}
                        ...
                        <div className="mt-3 space-y-1">
                            <p className="text-[10px] text-white/15">
                                By Systems Architect Ramon Luis Rios Jr.
                            </p>
                            <a
                                href="https://ramonrios.net"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-[10px] text-white/20 hover:text-cyan-400/60 transition-colors block"
                            >
                                RamonRios.Net
                            </a>
                            <a
                                ...
                                className="text-[10px] text-white/20 hover:text-cyan-400/60 transition-colors block"
                            >
                                Coqui Cloud Dev Co. (coqui.cloud)
                            </a>
                        </div>
                    </div>
                    ...
                    {Object.entries(footerLinks).map(([section, links]) => (
                        <div key={section}>
                            <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-4 border-b border-white/10 pb-1">
                                {section}
                            </p>
                                    ...
                                    <li key={link.label}>
                                        {link.isExternal ? (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-xs text-cyan-400 hover:text-cyan-300 transition-colors font-bold flex items-center gap-1"
                                            >
                                                {link.label}{" "}
                                            ...
                                            <Link
                                                ...
                                                className="text-xs text-white/50 hover:text-cyan-400 transition-colors font-medium"
                                            >
                                                {link.label}
                                            </Link>
                                        )}
                                        {link.disclaimer && (
                                            <p className="text-[9px] text-zinc-500 italic mt-1.5 leading-tight pr-4">
                                                {link.disclaimer}
                                            </p>
                                        )}
                                    </li>
                ...
                <div className="pt-8 pb-4 border-t border-white/[0.03] flex flex-col md:flex-row items-center justify-center gap-6 md:gap-16">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 border-r border-white/10 pr-4 mr-1">
                            <a
                                href="https://www.facebook.com/HumanosFoundation"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-1.5 text-white/20 hover:text-blue-500 hover:bg-blue-500/10 rounded-md transition-all"
                                aria-label="Facebook"
                            >
                                <Facebook className="w-3.5 h-3.5" />
                            </a>
                            <a
                                href="https://github.com/RamonRiosJr/humanos.foundation"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-1.5 text-white/20 hover:text-white hover:bg-white/10 rounded-md transition-all"
                                aria-label="GitHub"
                            >
                                <Github className="w-3.5 h-3.5" />
                            </a>
                            <a
                                href="https://www.youtube.com/@HumanosFoundation"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="p-1.5 text-white/20 hover:text-red-500 hover:bg-red-500/10 rounded-md transition-all"
                                aria-label="YouTube"
                            >
                        ...
                        <a
                            ...
                            className="text-[10px] text-white/15 hover:text-cyan-400/60 transition-colors"
                        >
