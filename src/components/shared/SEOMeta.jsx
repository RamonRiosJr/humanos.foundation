...
export default function SEOMeta({
    ...
    noindex = false,
    keywords = "", // Dynamic high-level SEO keyword injection
}) {
    const fullTitle = title.includes("Humanos")
        ? title
    ...
    useEffect(() => {
        ...
        // Basic SEO
        const baseKeywords =
            "health data sovereignty, patient data rights, hOS, human operating system, FTC HBNR personal health record, Zero-Knowledge Healthcare, patient owned health record, health data portability, Ramon Rios, Humanos Foundation, RamonRios.Net";
        ...
        setMeta(
            "twitter:card",
            type === "article" ? "summary_large_image" : "summary_large_image",
        );
            ...
            "@graph": [
                {
                    ...
                    description:
                        "A movement dedicated to returning health data sovereignty to every individual.",
                    founder: {
                        "@type": "Person",
