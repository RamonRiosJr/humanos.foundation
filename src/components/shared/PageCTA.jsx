...
export default function PageCTA({
    ...
    subtitle = "Join thousands building the movement for patient data sovereignty.",
        ...
        <section className="relative py-24 md:py-32 px-4 md:px-8">
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center">
                ...
                >
                    ...
                    <p className="text-sm text-white/70 mb-8 leading-relaxed max-w-xl mx-auto font-medium">
                        {subtitle}
                    </p>
                    <Link
